...
case $op in                                                                                     #perforn operation according to the user choice
    ...
    3)
        echo
        echo "<<--Thank You-->>"                                    #if user select '3' print this statement
        ;;
    *)
        echo "Please enter valid option"                            #if user does not select the option from available menu then print this statement
        attempt=y
        echo
        ;;
 esac
